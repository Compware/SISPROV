...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="665" style='border-collapse: collapse;
        table-layout: fixed; width: 599pt'>
			...
			<td colspan="6">
				<table>
					...
					<tr height="17" style='height: 12.75pt'>
						...
						<td colspan="3" class="xl67">
							RELATÓRIO<span style='mso-spacerun: yes'> </span> DE ACONSELHAMENTO ATIP
						</td>
						<td colspan="2" class="xl65" style='mso-ignore: colspan'>
						</td>
					</tr>
        ...
        <tr height="18" style='height: 13.5pt'>
            ...
            <td rowspan="3" class="xl342" width="149" style='border-bottom: 1.0pt solid black;
                width: 112pt'>
                <font class="font7">ACONSELHADOS</font>
            </td>
        ...
        <tr height="17" style='height: 12.75pt'>
            ...
            <td rowspan="2" class="xl355" width="100" style='border-bottom: 1.0pt solid black;border-right: 2.0pt double black;
                border-top: none; width: 75pt'>
                TOTAL
            </td>
        ...
        <tr height="21" style='height: 15.75pt'>
            <td colspan="7" height="21" class="xl359" width="205" 
				style='border-right: .5pt solid black;border-right: 2.0pt double black;                
                height: 15.75pt; width: 154pt'>
                1.1.<span style='mso-spacerun: yes'> </span>CRIANÇAS
            </td>
        </tr>
        <tr height="17" style='height: 12.75pt'>
            <td rowspan="6" height="69" class="xl315" width="136" style='border-bottom: 1.0pt solid black;
			...
			<td rowspan="2" class="xl322" width="100" style='border-bottom: .5pt solid black;border-right: 2.0pt double black;
                width: 75pt'>
        ...
        <tr height="21" style='height: 15.75pt'>
            <td colspan="7" height="21" class="xl359" width="205" style='border-right: 2.0pt double black;
        ...
        <tr height="21" style='height: 15.75pt'>
            ...
            <td class="xl322" width="100" style='border-bottom: .5pt solid black;
                width: 75pt'>
			...
			<td class="xl322" width="100" style='border-bottom: .5pt solid black;border-right: 2.0pt double black;
                width: 75pt'>
        ...
        <tr height="17" style='height: 12.75pt'>
            ...
            <td class="xl330" width="149" style='border-bottom: .5pt solid black;
                width: 112pt'>
                <xsl:value-of select="Programa/Dados/sgATV_L23C2"/>
            </td>
            <td class="xl330" width="111" style='border-bottom: .5pt solid black;
                width: 83pt'>
                <xsl:value-of select="Programa/Dados/sgATV_L23C3"/>
            </td>
            <td class="xl330" width="100" style='border-bottom: .5pt solid black;
                width: 75pt'>
			...
			<td class="xl330" width="100" style='border-bottom: .5pt solid black;border-right: 2.0pt double black;
                width: 75pt'>
        ...
        <tr height="23" style='height: 17.25pt'>
            ...
            <td class="xl171" width="149" style='border-bottom: .5pt solid black;
                width: 112pt'>
                <xsl:value-of select="Programa/Dados/sgATV_L24C2"/>
            </td>
            <td class="xl171" width="111" style='border-bottom: .5pt solid black;
                width: 83pt'>
                <xsl:value-of select="Programa/Dados/sgATV_L24C3"/>
            </td>
            <td class="xl171" width="100" style='border-bottom: .5pt solid black;
                width: 75pt'>
			...
			<td class="xl171" width="100" style='border-bottom: .5pt solid black;border-right: 2.0pt double black;
                width: 75pt'>
        ...
        <tr height="23" style='height: 17.25pt'>
            ...
            <td class="xl171" width="149" style='border-bottom: 2.0pt double black;
                width: 112pt'>
                <xsl:value-of select="Programa/Dados/sgATV_L25C2"/>
            </td>
            <td class="xl171" width="111" style='border-bottom: 2.0pt double black;
                width: 83pt'>
                <xsl:value-of select="Programa/Dados/sgATV_L25C3"/>
            </td>
            <td class="xl171" width="100" style='border-bottom: 2.0pt double black;
                width: 75pt'>
			...
			<td class="xl171" width="100" style='border-bottom: 2.0pt double black;border-right: 2.0pt double black;
