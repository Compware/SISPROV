inherited frmRelFixos: TfrmRelFixos
  Left = 446
  Top = 61
  Caption = 'Relat'#243'rio Fixos'
  ClientHeight = 525
  ClientWidth = 510
  Font.Name = 'Arial'
  OldCreateOrder = True
  ...
  inherited pgFiltros: TPageControl
    ...
    object pgFiltro: TTabSheet
      ...
      object GroupBox2: TGroupBox
        ...
        ParentFont = False
        TabOrder = 1
        object rbNovos: TRadioButton
          Left = 16
          Top = 24
          Width = 250
          Height = 17
          Caption = 'Pacientes Novos'
          Checked = True
          TabOrder = 0
          TabStop = True
        end
        object rbObito: TRadioButton
          Left = 16
          Top = 43
          Width = 250
          Height = 17
        ...
        object rbTranfSaida: TRadioButton
          Left = 16
          Top = 62
          Width = 250
          Height = 17
          Caption = 'Transfer'#234'ncia Sa'#237'da'
          TabOrder = 2
        end
        object rbAbandono: TRadioButton
          Left = 16
          Top = 81
          Width = 250
          Height = 17
        ...
        object rbCd4500: TRadioButton
          Left = 16
          Top = 157
          Width = 306
          Height = 17
          Caption = 'CD4 >= 500 sem TARV'
          TabOrder = 4
        end
        object rbestadio3e4: TRadioButton
          Left = 16
          Top = 138
          Width = 306
          Height = 17
          Caption = 'Estadio III e IV da OMS sem TARV'
          TabOrder = 5
        end
        object rbGestante: TRadioButton
          Left = 16
          Top = 119
          Width = 250
          Height = 17
        ...
        object rbCargaViralSem: TRadioButton
          Left = 16
          Top = 214
          Width = 306
          Height = 17
          Caption = 'Pacientes sem resultado de carga viral'
          TabOrder = 8
        end
        object rbCargaViralMenos1000: TRadioButton
          Left = 16
          Top = 195
          Width = 309
          Height = 17
          Caption = 'Pacientes com carga viral >= 1000 c'#243'pias'
          TabOrder = 9
        end
        object rbCriancasMenores10: TRadioButton
          Left = 16
          Top = 176
          Width = 306
          Height = 17
          Caption = 'Crian'#231'as <= 10 Anos sem TARV'
          TabOrder = 10
        end
      end
    end
  ...
  inherited qyGeral: TIBQuery
    ...
    SQL.Strings = (
      ...
      '    DT_CV_UC DT_COLETA_EXAME,'
        ...
        '        WHERE CD_PACIENTE = R.CD_PACIENTE ORDER BY DT_PRIMEIRA_C' +
        'ONSULTA ASC) DT_PRIMEIRA_CONSULTA,'
      '    (SELECT FIRST 1 DT_PRIMEIRO_TARV FROM MAPA_MEDICO_LINHA'
      
        '        WHERE CD_PACIENTE = R.CD_PACIENTE ORDER BY DT_PRIMEIRO_T' +
        'ARV ASC) PRIMEIRO_TARV,'
      '    (SELECT FIRST 1 DT_ULTIMA_CONSULTA FROM MAPA_MEDICO_LINHA'
      
        '        WHERE CD_PACIENTE = R.CD_PACIENTE ORDER BY DT_ULTIMA_CON' +
        'SULTA DESC) DT_ULTIMA_CONSULTA,'
      '    (SELECT FIRST 1 VL_ULTIMA_ESQUEMA FROM MAPA_MEDICO_LINHA'
      
        '        WHERE CD_PACIENTE = R.CD_PACIENTE ORDER BY DT_ULTIMA_CON' +
        'SULTA DESC) ULTIMO_TARV'
      'FROM'
      '    (SELECT DISTINCT'
      '        P.CD_PACIENTE,'
      '        P.NR_PROCESSO,'
      ...
      '        DT_CV_UC,'
        ...
        '        CASE P.TP_SEXO WHEN '#39'M'#39' THEN '#39'MASCULINO'#39' WHEN '#39'F'#39' THEN '#39 +
        'FEMININO'#39' END TP_SEXO,'
      '        N.DT_DIAGNOSTICO,'
      '        CASE N.TP_ENTRADA'
      '            WHEN 1 THEN '#39'Caso Novo'#39
      '            WHEN 2 THEN '#39'Transfer'#234'ncia'#39
      '            WHEN 3 THEN '#39'Retorno ap'#243's abandono'#39
      '            WHEN 4 THEN '#39'Ignorado'#39
      '            WHEN 5 THEN '#39'M'#227'e de crian'#231'a exposta'#39
      '            WHEN 6 THEN '#39'Caso novo-Internamento'#39
      '        END TP_ENTRADA'
      '    FROM NOTIFICACAO N'
      ...
      '    WHERE'
      '        MM.DT_MAPA BETWEEN :INICIO AND :FIM'
      '        AND (TRIM(VL_CV_UC) = '#39#39' OR VL_CV_UC IS NULL)) R'
  ...
  inherited frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 42678.417286203700000000
    ScriptText.Strings = (
      ''
      'procedure Memo8OnBeforePrint(Sender: TfrxComponent);'
      'begin'
      '      if (<frxDBDataset1."TP_ENTRADA"> = 1 ) then'
      '     Memo8.Memo.text := '#39'CASOS NOVOS'#39
      '  else Memo8.Memo.text := '#39'TRASFER'#202'MCIA ENTRADA'#39'  '
      'end;'
      ''
      'begin'
      '        '
    ...
    object Page1: TfrxReportPage
      ...
      object ReportTitle1: TfrxReportTitle
        ...
        object Memo3: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8 = (
            'RELAT'#195#8220'RIO FIXO - PACIENTES NOVOS')
          ParentFont = False
        end
        object Memo46: TfrxMemoView
          Left = 3.779530000000000000
          Top = 264.669450000000000000
        ...
        object Memo14: TfrxMemoView
          ...
          Font.Style = [fsBold]
          Memo.UTF8 = (
            'PER'#195#141'ODO DIA/M'#195#352'S/ANO')
          ParentFont = False
        end
        object iNICIO: TfrxMemoView
          Left = 177.637910000000000000
          Top = 207.976500000000000000
          Width = 109.606370000000000000
          Height = 15.118120000000000000
          ShowHint = False
          DataSet = frmCadMapaMedico.fxdbPaciente
        ...
        object frxDBUnidadeDS_UNIDADE: TfrxMemoView
      ...
      object MasterData1: TfrxMasterData
        ...
        object frxDBDataset1NR_PROCESSO_UTENTE: TfrxMemoView
          Left = 3.779530000000000000
          Top = 2.645669291338583000
          Width = 71.811070000000000000
          Height = 18.897650000000000000
          OnAfterPrint = 'frxDBDataset1NR_PROCESSO_UTENTEOnAfterPrint'
          OnBeforePrint = 'frxDBDataset1NR_PROCESSO_UTENTEOnBeforePrint'
          ShowHint = False
          ...
          Font.Style = []
          Memo.UTF8 = (
            '[frxDBDataset1."NR_PROCESSO"]')
          ParentFont = False
        end
        object frxDBDataset1DT_DIAGNOSTICO: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8 = (
            '[frxDBDataset1."DT_DIAGNOSTICO"]')
          ParentFont = False
        end
        object frxDBDataset1DT_PRIMEIRA_CONSULTA: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8 = (
            '[frxDBDataset1."DT_PRIMEIRA_CONSULTA"]')
          ParentFont = False
        end
        object frxDBDataset1NM_PACIENTE1: TfrxMemoView
        ...
        object frxDBDataset1TP_SEXO: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8 = (
            '[frxDBDataset1."TP_SEXO"]')
          ParentFont = False
        end
        object frxDBDataset1DT_NASCIMENTO: TfrxMemoView
          Left = 616.055505000000000000
          Top = 2.645669290000000000
          Width = 94.488250000000000000
          Height = 18.897650000000000000
          ShowHint = False
          ...
          HAlign = haCenter
          Memo.UTF8 = (
            '[frxDBDataset1."DT_NASCIMENTO"]')
          ParentFont = False
        end
      end
      object GroupHeader1: TfrxGroupHeader
        Height = 83.393754490000000000
        Top = 396.850650000000000000
        Width = 718.110700000000000000
        Condition = 'frxDBDataset1."TP_ENTRADA"'
        ...
        object Memo4: TfrxMemoView
          Left = 189.622140000000000000
          Top = 63.614224490000000000
          Width = 94.488250000000000000
          Height = 15.118120000000000000
          ShowHint = False
          Font.Charset = DEFAULT_CHARSET
          ...
          HAlign = haCenter
          Memo.UTF8 = (
            'Data 1'#194#170' Consulta')
          ParentFont = False
        end
        object Memo5: TfrxMemoView
          Left = 87.433210000000000000
          Top = 63.614224490000000000
          Width = 98.267780000000000000
          Height = 15.118120000000000000
          ShowHint = False
        ...
        object Line34: TfrxLineView
          Left = 288.196921180000000000
          Top = 56.937044490000000000
          Height = 26.456710000000000000
          ShowHint = False
          Diagonal = True
        end
        object Memo2: TfrxMemoView
          Left = 293.141930000000000000
          Top = 63.496104490000000000
          Width = 52.913420000000000000
          Height = 15.118120000000000000
          ShowHint = False
          Font.Charset = DEFAULT_CHARSET
        ...
        object Memo7: TfrxMemoView
          Left = 544.197328820000000000
          Top = 63.275634490000000000
          Width = 52.913420000000000000
          Height = 15.118120000000000000
          ShowHint = False
          Font.Charset = DEFAULT_CHARSET
