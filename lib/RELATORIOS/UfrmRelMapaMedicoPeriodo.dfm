inherited frmRelMapaMedicoPeriodo: TfrmRelMapaMedicoPeriodo
  Caption = 'Relat'#243'rio  - Mapa M'#233'dico'
  OldCreateOrder = True
  OnCreate = FormCreate
  PixelsPerInch = 96
  TextHeight = 13
  object Label2: TLabel [1]
    ...
    Width = 256
    Height = 48
    Caption = 'Relat'#243'rio'#13#10'Mapa M'#233'dico por Per'#237'odo'
  ...
  inherited qyGeral: TIBQuery
    ...
    SQL.Strings = (
      ...
      '    "MAPA_MEDICO"."CD_MAPA" = "MAPA_MEDICO_LINHA"."CD_MAPA"'
      '   left outer join "MEDICO" on'
      '    "MAPA_MEDICO"."CD_MEDICO" = "MEDICO"."CD_MEDICO"'
      'where  "MAPA_MEDICO"."DT_MAPA" between :DE and :ATE'
      '/*MEDICO*/'
      
        'order by  "MAPA_MEDICO".CD_MEDICO, "MAPA_MEDICO"."DT_MAPA"  desc' +
        ', "MAPA_MEDICO_LINHA"."CD_MAPA_LINHA" asc')
    Left = 16
    Top = 368
    ParamData = <
      item
  ...
  inherited frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 42469.870752060200000000
    Left = 144
    Datasets = <
      item
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object Memo24: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8 = (
            '[frxDBDataset1."FL_SEXO"]')
          ParentFont = False
        end
        object Line9: TfrxLineView
          Left = 398.031496060000000000
          Top = 0.118120000000000000
          Height = 30.236240000000000000
          ShowHint = False
          Diagonal = True
        ...
        object Memo20: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8 = (
            '[frxDBDataset1."DT_PRIMEIRO_TARV"]')
          ParentFont = False
        end
        object Memo21: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8 = (
            '[frxDBDataset1."VL_PRIMEIRO_ESQUEMA"]')
          ParentFont = False
        end
        ...
        object Memo39: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8 = (
            '[frxDBDataset1."DT_ULTIMA_CONSULTA"]')
          ParentFont = False
        end
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        Width = 1046.929810000000000000
        Condition = 'frxDBDataset1."CD_MEDICO"'
