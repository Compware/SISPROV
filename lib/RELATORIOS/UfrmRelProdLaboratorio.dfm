inherited frmRelProdLaboratorio: TfrmRelProdLaboratorio
  Left = 294
  Caption = 'Relat'#243'rio Produtividade Laborat'#243'rio'
  ClientHeight = 479
  ClientWidth = 593
  Font.Name = 'Arial'
  OldCreateOrder = True
  ...
  inherited qyGeral: TIBQuery
    SQL.Strings = (
      ...
      'FROM MAPA_LAB_PACIENTE MLP'
      'INNER JOIN MAPA_LAB ML'
      #9'ON ML.CD_MAPA = MLP.CD_MAPA'
      'WHERE ML.DT_MAPA >= :data_inicio AND ML.DT_MAPA <= :data_fim')
    Left = 16
    Top = 440
    ParamData = <
      item
  ...
  inherited frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 42675.364839976850000000
    Left = 80
    Top = 440
    Datasets = <
      item
      ...
      item
        DataSet = frxDBResultados
        DataSetName = 'frxDBResultados'
      end
      item
    ...
    object Page1: TfrxReportPage
      ...
      object ReportTitle1: TfrxReportTitle
        ...
        object Memo3: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8 = (
            'RELAT'#195#8220'RIO PRODUTIVIDADE LABORAT'#195#8220'RIO')
          ParentFont = False
        end
      ...
      object PageHeader1: TfrxPageHeader
        ...
        object Memo14: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8 = (
            '[frxDBResultados."CD4_DE_350_A_500"]')
          ParentFont = False
        end
        ...
        object Memo23: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8 = (
            '[frxDBResultados."CV_MAIOR_IGUAL_1000"]')
          ParentFont = False
        end
        ...
        object Memo29: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8 = (
            '[frxDBResultados."DPI_DETERMINADO"]')
          ParentFont = False
        end
        ...
        object Memo32: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8 = (
            '[frxDBResultados."DPI_INDETERMINADO"]')
          ParentFont = False
        end
  ...
  object qyResultados: TIBQuery
    ...
    SQL.Strings = (
      ...
      #9'CD4_DE_350_A_500,'
      #9'CD4_MAIOR_500,'
      #9'(CD4_Menor_350 +CD4_DE_350_A_500 + CD4_MAIOR_500) CD4_total,'
      #9'CV_Menor_1000,'
      #9'CV_MAIOR_IGUAL_1000,'
      #9'CV_LDL,'
      #9'(CV_Menor_1000 +CV_MAIOR_IGUAL_1000 + CV_LDL) CV_total,'
      #9'DPI_DETERMINADO,'
      #9'DPI_INDETERMINADO,'
      #9'(DPI_DETERMINADO + DPI_INDETERMINADO) DPI_TOTAL,'
      #9'TB_POSITIVO,'
      #9'TB_NEGATIVO,'
      #9'(TB_POSITIVO + TB_NEGATIVO) TB_TOTAL,'
      
        #9'(CD4_Menor_350 +CD4_DE_350_A_500 + CD4_MAIOR_500 + CV_Menor_100' +
        '0 +CV_MAIOR_IGUAL_1000 + CV_LDL + DPI_DETERMINADO + DPI_INDETERM' +
        'INADO + TB_POSITIVO + TB_NEGATIVO) Total_Exames'
      'FROM'
      #9'(SELECT '
      #9#9'COUNT(CD_PACIENTE) CD4_Menor_350'
      #9'FROM MAPA_LAB_PACIENTE MLP'
      #9'INNER JOIN MAPA_LAB ML'
      #9#9'ON ML.CD_MAPA = MLP.CD_MAPA'
      #9'WHERE'
      #9#9'ML.DT_MAPA >= :data_inicio AND ML.DT_MAPA <= :data_fim'
      
        #9#9'AND TP_EXAME_CD4='#39'S'#39' AND TRIM(VL_RESULTADO) SIMILAR TO '#39'[0-9]+' +
        #39' AND VL_RESULTADO < 350),'
      #9'(SELECT '
      #9#9'COUNT(CD_PACIENTE) CD4_DE_350_A_500'
      #9'FROM MAPA_LAB_PACIENTE MLP'
      #9'INNER JOIN MAPA_LAB ML'
      #9#9'ON ML.CD_MAPA = MLP.CD_MAPA'
      #9'WHERE'
      #9#9'ML.DT_MAPA >= :data_inicio AND ML.DT_MAPA <= :data_fim'
        ...
        #9#9'AND TP_EXAME_CD4='#39'S'#39' AND TRIM(VL_RESULTADO) SIMILAR TO '#39'[0-9]+' +
        #39' AND VL_RESULTADO >= 350 AND VL_RESULTADO <= 500),'
      #9'(SELECT '
      #9#9'COUNT(CD_PACIENTE) CD4_MAIOR_500'
      #9'FROM MAPA_LAB_PACIENTE MLP'
      #9'INNER JOIN MAPA_LAB ML'
      #9#9'ON ML.CD_MAPA = MLP.CD_MAPA'
      #9'WHERE'
      #9#9'ML.DT_MAPA >= :data_inicio AND ML.DT_MAPA <= :data_fim'
        ...
        #9#9'AND TP_EXAME_CD4='#39'S'#39' AND TRIM(VL_RESULTADO) SIMILAR TO '#39'[0-9]+' +
        #39' AND VL_RESULTADO > 500),'
      #9'(SELECT '
      #9#9'COUNT(CD_PACIENTE) CV_Menor_1000'
      #9'FROM MAPA_LAB_PACIENTE MLP'
      #9'INNER JOIN MAPA_LAB ML'
      #9#9'ON ML.CD_MAPA = MLP.CD_MAPA'
      #9'WHERE'
      #9#9'ML.DT_MAPA >= :data_inicio AND ML.DT_MAPA <= :data_fim'
        ...
        #9#9'AND TP_EXAME_CV='#39'S'#39' AND TRIM(VL_RESULTADO) SIMILAR TO '#39'[0-9]+'#39 +
        ' AND VL_RESULTADO < 1000),'
      #9'(SELECT '
      #9#9'COUNT(CD_PACIENTE) CV_MAIOR_IGUAL_1000'
      #9'FROM MAPA_LAB_PACIENTE MLP'
      #9'INNER JOIN MAPA_LAB ML'
      #9#9'ON ML.CD_MAPA = MLP.CD_MAPA'
      #9'WHERE'
      #9#9'ML.DT_MAPA >= :data_inicio AND ML.DT_MAPA <= :data_fim'
        ...
        ' AND VL_RESULTADO >= 1000),'
      #9'(SELECT '
      #9#9'COUNT(CD_PACIENTE) CV_LDL'
      #9'FROM MAPA_LAB_PACIENTE MLP'
      #9'INNER JOIN MAPA_LAB ML'
      #9#9'ON ML.CD_MAPA = MLP.CD_MAPA'
      #9'WHERE'
      #9#9'ML.DT_MAPA >= :data_inicio AND ML.DT_MAPA <= :data_fim'
      #9#9'AND TP_EXAME_CV='#39'S'#39' AND VL_RESULTADO = '#39'<LDL'#39'),'
      #9'(SELECT '
      #9#9'COUNT(CD_PACIENTE) DPI_DETERMINADO'
      #9'FROM MAPA_LAB_PACIENTE MLP'
      #9'INNER JOIN MAPA_LAB ML'
      #9#9'ON ML.CD_MAPA = MLP.CD_MAPA'
      #9'WHERE'
      #9#9'ML.DT_MAPA >= :data_inicio AND ML.DT_MAPA <= :data_fim'
      #9#9'AND TP_EXAME_DPI='#39'S'#39' AND VL_RESULTADO = '#39'DETERMINADO'#39'),'
      #9'(SELECT '
      #9#9'COUNT(CD_PACIENTE) DPI_INDETERMINADO'
      #9'FROM MAPA_LAB_PACIENTE MLP'
      #9'INNER JOIN MAPA_LAB ML'
      #9#9'ON ML.CD_MAPA = MLP.CD_MAPA'
      #9'WHERE'
      #9#9'ML.DT_MAPA >= :data_inicio AND ML.DT_MAPA <= :data_fim'
      #9#9'AND TP_EXAME_DPI='#39'S'#39' AND VL_RESULTADO = '#39'INDETERMINADO'#39'),'
      #9'(SELECT '
      #9#9'COUNT(CD_PACIENTE) TB_POSITIVO'
      #9'FROM MAPA_LAB_PACIENTE MLP'
      #9'INNER JOIN MAPA_LAB ML'
      #9#9'ON ML.CD_MAPA = MLP.CD_MAPA'
      #9'WHERE'
      #9#9'ML.DT_MAPA >= :data_inicio AND ML.DT_MAPA <= :data_fim'
      #9#9'AND TP_EXAME_TB='#39'S'#39' AND VL_RESULTADO = '#39'POSITIVO'#39'),'
      #9'(SELECT '
      #9#9'COUNT(CD_PACIENTE) TB_NEGATIVO'
      #9'FROM MAPA_LAB_PACIENTE MLP'
      #9'INNER JOIN MAPA_LAB ML'
      #9#9'ON ML.CD_MAPA = MLP.CD_MAPA'
      #9'WHERE'
      #9#9'ML.DT_MAPA >= :data_inicio AND ML.DT_MAPA <= :data_fim'
      #9#9'AND TP_EXAME_TB='#39'S'#39' AND VL_RESULTADO = '#39'NEGATIVO'#39')')
    Left = 16
    Top = 400
    ParamData = <
      item
    ...
    object qyResultadosCD4_MENOR_350: TIntegerField
      FieldName = 'CD4_MENOR_350'
      Required = True
    end
    object qyResultadosCD4_DE_350_A_500: TIntegerField
      FieldName = 'CD4_DE_350_A_500'
      Required = True
    end
    object qyResultadosCD4_MAIOR_500: TIntegerField
      FieldName = 'CD4_MAIOR_500'
      Required = True
    end
    object qyResultadosCD4_TOTAL: TLargeintField
      FieldName = 'CD4_TOTAL'
      Required = True
    end
    object qyResultadosCV_MENOR_1000: TIntegerField
      FieldName = 'CV_MENOR_1000'
      Required = True
    end
    object qyResultadosCV_MAIOR_IGUAL_1000: TIntegerField
      FieldName = 'CV_MAIOR_IGUAL_1000'
      Required = True
    end
    object qyResultadosCV_LDL: TIntegerField
      FieldName = 'CV_LDL'
      Required = True
    end
    object qyResultadosCV_TOTAL: TLargeintField
      FieldName = 'CV_TOTAL'
      Required = True
    end
    object qyResultadosDPI_TOTAL: TLargeintField
      FieldName = 'DPI_TOTAL'
      Required = True
    end
    object qyResultadosTOTAL_EXAMES: TLargeintField
      FieldName = 'TOTAL_EXAMES'
      Required = True
    end
    object qyResultadosDPI_DETERMINADO: TIntegerField
      FieldName = 'DPI_DETERMINADO'
      Required = True
    end
    object qyResultadosDPI_INDETERMINADO: TIntegerField
      FieldName = 'DPI_INDETERMINADO'
      Required = True
    end
    object qyResultadosTB_POSITIVO: TIntegerField
      FieldName = 'TB_POSITIVO'
      Required = True
    end
    object qyResultadosTB_NEGATIVO: TIntegerField
      FieldName = 'TB_NEGATIVO'
      Required = True
    end
    object qyResultadosTB_TOTAL: TLargeintField
      FieldName = 'TB_TOTAL'
      Required = True
    end
  end
  object dsResultados: TDataSource
    DataSet = qyResultados
    Left = 48
    Top = 400
  end
  ...
  object frxDBResultados: TfrxDBDataset
    UserName = 'frxDBResultados'
    CloseDataSource = False
    FieldAliases.Strings = (
      'CD4_MENOR_350=CD4_MENOR_350'
      'CD4_DE_350_A_500=CD4_DE_350_A_500'
      'CD4_MAIOR_500=CD4_MAIOR_500'
      'CD4_TOTAL=CD4_TOTAL'
      ...
      'DPI_DETERMINADO=DPI_DETERMINADO'
      'DPI_INDETERMINADO=DPI_INDETERMINADO'
      'TB_POSITIVO=TB_POSITIVO'
      'TB_NEGATIVO=TB_NEGATIVO'
      'TB_TOTAL=TB_TOTAL')
    DataSource = dsResultados
    BCDToCurrency = False
    Left = 112
