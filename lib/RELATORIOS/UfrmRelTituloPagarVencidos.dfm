inherited frmRelTituloPagarVencidos: TfrmRelTituloPagarVencidos
  OldCreateOrder = True
  OnCreate = FormCreate
  PixelsPerInch = 96
  TextHeight = 13
  inherited Label1: TLabel
    Width = 277
    Height = 48
    Caption = 'Relat'#243'rio'#13#10'Titulos a Pagar - (Vencidos)'
  end
  ...
  object RvDtCnTituloPagarVencidos: TRvDataSetConnection
    RuntimeVisibility = rtDeveloper
    DataSet = qyGeral
    Left = 16
    Top = 254
  end
  object RvDtCnTituloPagarVencidosConfRel: TRvDataSetConnection
    RuntimeVisibility = rtDeveloper
    DataSet = DMRelatorios.qyConfRelatorio
    Left = 56
    Top = 254
  end
  object RvSysTituloPagarVencidos: TRvSystem
  ...
  object RvPrjTituloPagarVencidos: TRvProject
    Engine = RvSysTituloPagarVencidos
    ProjectFile = 'RelTituloPagarVencidos.rav'
    OnCreate = RvPrjTituloPagarVencidosCreate
    Left = 16
    Top = 318
  end
end
