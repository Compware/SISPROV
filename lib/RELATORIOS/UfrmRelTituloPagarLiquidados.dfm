inherited frmRelTituloPagarLiquidados: TfrmRelTituloPagarLiquidados
  Left = 374
  Top = 127
  PixelsPerInch = 96
  TextHeight = 13
  inherited Label1: TLabel
    Width = 296
    Height = 48
    Caption = 'Relat'#243'rios'#13#10'Titulos a Pagar - (Liquidados)'
  end
  ...
  inherited qyGeral: TIBQuery
    ...
    SQL.Strings = (
      ...
      'and TITULO_PAGAR.SG_STATUS = '#39'B'#39
    ...
    object qyGeralCD_EMPRESA_ORIGEM: TIntegerField
      ...
      Origin = 'TITULO_PAGAR.CD_EMPRESA_ORIGEM'
    end
    object qyGeralDT_CADASTRO: TDateTimeField
      FieldName = 'DT_CADASTRO'
      Origin = 'TITULO_PAGAR.DT_CADASTRO'
    end
    object qyGeralCD_NF: TIntegerField
      FieldName = 'CD_NF'
      Origin = 'TITULO_PAGAR.CD_NF'
    end
    object qyGeralCD_VENDA: TIntegerField
      FieldName = 'CD_VENDA'
      Origin = 'TITULO_PAGAR.CD_VENDA'
    end
  ...
  object RvDtCnTituloPagarLiquidados: TRvDataSetConnection
    RuntimeVisibility = rtDeveloper
    DataSet = qyGeral
    Left = 16
    Top = 254
  end
  object RvSysTituloPagarLiquidados: TRvSystem
  ...
  object RvPrjTituloPagarLiquidados: TRvProject
    Engine = RvSysTituloPagarLiquidados
    ProjectFile = 'RelTituloPagarAVencer.rav'
    OnCreate = RvPrjTituloPagarLiquidadosCreate
    Left = 16
    Top = 318
  end
  object RvDtCnTituloPagarLiquidadosConfRel: TRvDataSetConnection
    RuntimeVisibility = rtDeveloper
