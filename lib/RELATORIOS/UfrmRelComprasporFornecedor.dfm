inherited frmRelComprasporFornecedor: TfrmRelComprasporFornecedor
  OldCreateOrder = True
  OnCreate = FormCreate
  PixelsPerInch = 96
  TextHeight = 13
  inherited Label1: TLabel
    Width = 255
    Height = 48
    Caption = 'Relat'#243'rio'#13#10'Compras por Fornecedor'
  end
  inherited pgFiltros: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object GroupBox2: TGroupBox
        ...
        object btFornecedorLimpar: TSpeedButton
          Left = 386
          Top = 36
          Width = 25
          Height = 24
          ...
          ParentShowHint = False
          ShowHint = True
          OnClick = btFornecedorLimparClick
        end
  ...
  inherited rvGeral: TRvProject
    ProjectFile = 'C:\Compware\Layout\RelComprasporFornecedor.rav'
  end
