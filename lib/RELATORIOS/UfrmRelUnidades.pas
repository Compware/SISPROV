...
type
  TfrmRelUnidades = class(TfrmRelPad)
    TabSheet1: TTabSheet;
    GroupBox1: TGroupBox;
    Label3: TLabel;
    Label4: TLabel;
...
var
  frmRelUnidades: TfrmRelUnidades;
  strSQL:String;
implementation
...
procedure TfrmRelUnidades.cbTodosClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmRelUnidades.btImprimirClick(Sender: TObject);
...
procedure TfrmRelUnidades.btLocProvinciaButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
  inherited;
...
procedure TfrmRelUnidades.btLocProvinciaChange(Sender: TObject);
begin
  inherited;
  if btLocProvincia.Text = '' then
    edProvincia.Clear
...
procedure TfrmRelUnidades.btLocProvinciaExit(Sender: TObject);
begin
  inherited;
  if btLocProvincia.Text <> '' then
  begin
...
procedure TfrmRelUnidades.btLocMunicipioButtonClick(Sender: TObject;
  AbsoluteIndex: Integer);
begin
  inherited;
  frmLocalizar := TfrmLocalizar.Create(application);
...
procedure TfrmRelUnidades.btLocMunicipioChange(Sender: TObject);
begin
  inherited;
  if btLocMunicipio.Text = '' then
    edMunicipio.Clear
...
procedure TfrmRelUnidades.btLocMunicipioExit(Sender: TObject);
begin
  inherited;
  if btLocMunicipio.Text <> '' then
    begin
...
procedure TfrmRelUnidades.FormCreate(Sender: TObject);
begin
  inherited;
  strSQL := qyUnidades.SQL.Text;
end;

procedure TfrmRelUnidades.cbAtivasClick(Sender: TObject);
begin
  inherited;
  if cbAtivas.Checked then
    cbInativas.Checked := false;
...
procedure TfrmRelUnidades.cbInativasClick(Sender: TObject);
begin
  inherited;
  if cbInativas.Checked then
    cbAtivas.Checked := false;
