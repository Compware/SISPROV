inherited frmRelTituloReceberAVencer: TfrmRelTituloReceberAVencer
  OldCreateOrder = True
  PixelsPerInch = 96
  TextHeight = 13
  inherited Label1: TLabel
    Width = 300
    Height = 48
    Caption = 'Relat'#243'rio'#13#10'Titulos a Receber - (A Vencer)'
  end
  ...
  object RvDtCnTituloReceberAVencer: TRvDataSetConnection
    RuntimeVisibility = rtDeveloper
    DataSet = qyGeral
    Left = 16
    Top = 254
  end
  object RvDtCnTituloReceberAVencerConfRel: TRvDataSetConnection
    RuntimeVisibility = rtDeveloper
    DataSet = DMRelatorios.qyConfRelatorio
    Left = 56
    Top = 254
  end
  object RvSysTituloReceberAVencer: TRvSystem
  ...
  object RvPrjTituloReceberAVencer: TRvProject
    Engine = RvSysTituloReceberAVencer
    ProjectFile = 'RelTituloReceberAVencer.rav'
    OnCreate = RvPrjTituloReceberAVencerCreate
    Left = 16
    Top = 318
  end
end
