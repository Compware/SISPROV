...
type
  TfrmRelABCCliente = class(TfrmRelPad)
    TabSheet1: TTabSheet;
    GroupBox3: TGroupBox;
    Label3: TLabel;
    Label8: TLabel;
...
var
  frmRelABCCliente: TfrmRelABCCliente;
  strSQL:string;
implementation
...
procedure TfrmRelABCCliente.btImprimirClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmRelABCCliente.btFamiliaClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmRelABCCliente.btFamiliaLimparClick(Sender: TObject);
begin
  inherited;
  edCod.Clear;
  edCliente.Clear;
...
procedure TfrmRelABCCliente.FormCreate(Sender: TObject);
begin
  inherited;
