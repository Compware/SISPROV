inherited frmRelProdAgendas: TfrmRelProdAgendas
  Caption = 'Relat'#243'rio Produtividade Agendas'
  ClientHeight = 419
  ClientWidth = 566
  Font.Name = 'Arial'
  OldCreateOrder = True
  ...
  inherited pgFiltros: TPageControl
    ...
    object pgRelatorio: TTabSheet
      ...
      object dxDBGrid1: TdxDBGrid
        ...
        object dxDBGrid1NM_MEDICO: TdxDBGridMaskColumn
        ...
        object dxDBGrid1MAPAS_VINCULADOS: TdxDBGridMaskColumn
          Caption = 'Tipo de Servi'#231'o'
          Width = 165
          BandIndex = 0
          RowIndex = 0
          FieldName = 'MAPAS_VINCULADOS'
        end
        object dxDBGrid1AGENDADOS: TdxDBGridMaskColumn
          Caption = 'Agendados'
          Width = 70
          BandIndex = 0
          RowIndex = 0
        ...
        object dxDBGrid1NAO_CONFIRMADOS: TdxDBGridMaskColumn
          Caption = 'N'#227'o Confirmados'
          Width = 102
          BandIndex = 0
          RowIndex = 0
          FieldName = 'NAO_CONFIRMADOS'
        end
        object dxDBGrid1REALIZADO: TdxDBGridColumn
          Caption = 'Realizados'
          Width = 70
          BandIndex = 0
          RowIndex = 0
  ...
  inherited qyGeral: TIBQuery
    SQL.Strings = (
      ...
      #9'MEDICO.NM_MEDICO,'
        ...
        #9'(SELECT CAST(LIST(MAPA, ASCII_CHAR(13)||ASCII_CHAR(10)) AS VARC' +
        'HAR(200))'
      #9' FROM (SELECT MAPA FROM'
      
        #9#9'(SELECT FIRST 1 '#39'MAPA FARM'#193'CIA'#39' MAPA FROM MAPA_FARMACIA WHERE ' +
        'MAPA_FARMACIA.CD_MEDICO = MEDICO.CD_MEDICO UNION'
      
        #9#9'SELECT FIRST 1 '#39'MAPA M'#201'DICO'#39' MAPA FROM MAPA_MEDICO WHERE MAPA_' +
        'MEDICO.CD_MEDICO = MEDICO.CD_MEDICO UNION'
      
        #9#9'SELECT FIRST 1 '#39'MAPA LABORAT'#211'RIO'#39' MAPA FROM MAPA_LAB WHERE MAP' +
        'A_LAB.CD_MEDICO = MEDICO.CD_MEDICO UNION'
      
        #9#9'SELECT FIRST 1 '#39'MAPA CRIAN'#199'A EXPOSTA'#39' MAPA FROM MAPA_CRIANCA_E' +
        'XPOSTA WHERE MAPA_CRIANCA_EXPOSTA.CD_MEDICO = MEDICO.CD_MEDICO U' +
        'NION'
      
        #9#9'SELECT FIRST 1 '#39'MAPA TESTE R'#193'PIDO'#39' MAPA FROM MAPA_TESTE_RAPIDO' +
        ' WHERE MAPA_TESTE_RAPIDO.CD_MEDICO = MEDICO.CD_MEDICO)'
      #9#9'ORDER BY MAPA ASC) '
      #9') MAPAS_VINCULADOS,'
      #9'(SELECT '
      #9#9'COUNT(AGENDA.CD_AGENDA)'
      #9'FROM AGENDA'
      #9'WHERE'
      
        #9#9'(AGENDA.DT_AGENDA >= :data_inicio and AGENDA.DT_AGENDA <= :dat' +
        'a_fim'
      #9#9#9'AND AGENDA.CD_MEDICO = MEDICO.CD_MEDICO)) AGENDADOS,'
      #9'(SELECT '
      #9#9'COUNT(AGENDA.CD_AGENDA)'
      #9'FROM AGENDA'
      #9'WHERE'
        ...
        #9#9#9'AND AGENDA.CD_MEDICO = MEDICO.CD_MEDICO AND AGENDA.FL_CONFIRM' +
        'ADO = 0)) NAO_CONFIRMADOS,'
      #9'(SELECT SUM(TOTAL) REALIZADO FROM'
      
        #9#9'(SELECT COUNT(CD_MAPA_FARMACIA_LINHA) TOTAL FROM MAPA_FARMACIA' +
        '_LINHA '
      
        #9#9' WHERE CD_MAPA_FARMACIA IN (SELECT CD_MAPA_FARMACIA MAPA FROM ' +
        'MAPA_FARMACIA '
      #9#9#9#9#9#9#9#9#9'WHERE MAPA_FARMACIA.CD_MEDICO = MEDICO.CD_MEDICO'
      
        #9#9#9#9#9#9#9#9#9'AND DT_MAPA >= :data_inicio and DT_MAPA <= :data_fim) U' +
        'NION'
      
        #9#9'SELECT COUNT(CD_MAPA_CRIANCA_EXPOSTA_LINHA) TOTAL FROM MAPA_CR' +
        'IANCA_EXPOSTA_LINHA '
      
        #9#9' WHERE CD_MAPA_CRIANCA_EXPOSTA IN (SELECT CD_MAPA_CRIANCA_EXPO' +
        'STA MAPA FROM MAPA_CRIANCA_EXPOSTA '
      #9#9#9#9#9#9#9#9#9'WHERE MAPA_CRIANCA_EXPOSTA.CD_MEDICO = MEDICO.CD_MEDICO'
      
        #9#9#9#9#9#9#9#9#9'AND DT_MAPA >= :data_inicio and DT_MAPA <= :data_fim) U' +
        'NION'
      #9#9'SELECT COUNT(CD_MAPA_PACIENTE) TOTAL FROM MAPA_LAB_PACIENTE '
      #9#9' WHERE CD_MAPA IN (SELECT CD_MAPA MAPA FROM MAPA_LAB '
      #9#9#9#9#9#9#9#9#9'WHERE MAPA_LAB.CD_MEDICO = MEDICO.CD_MEDICO'
      
        #9#9#9#9#9#9#9#9#9'AND DT_MAPA >= :data_inicio and DT_MAPA <= :data_fim) U' +
        'NION'
      #9#9'SELECT COUNT(CD_MAPA_LINHA) TOTAL FROM MAPA_MEDICO_LINHA'
      #9#9' WHERE CD_MAPA IN (SELECT CD_MAPA MAPA FROM MAPA_MEDICO'
      #9#9#9#9#9#9#9#9#9'WHERE MAPA_MEDICO.CD_MEDICO = MEDICO.CD_MEDICO'
      
        #9#9#9#9#9#9#9#9#9'AND DT_MAPA >= :data_inicio and DT_MAPA <= :data_fim) U' +
        'NION'
      
        #9#9'SELECT COUNT(CD_MAPA_PACIENTE) TOTAL FROM MAPA_TESTE_RAPIDO_PA' +
        'CIENTE '
      #9#9' WHERE CD_MAPA IN (SELECT CD_MAPA MAPA FROM MAPA_TESTE_RAPIDO'
      #9#9#9#9#9#9#9#9#9'WHERE MAPA_TESTE_RAPIDO.CD_MEDICO = MEDICO.CD_MEDICO'
      
        #9#9#9#9#9#9#9#9#9'AND DT_MAPA >= :data_inicio and DT_MAPA <= :data_fim)))' +
        ' REALIZADO'
      'FROM MEDICO'
      'ORDER BY MEDICO.NM_MEDICO ASC')
    Left = 16
    ParamData = <
      item
        DataType = ftUnknown
    ...
    object qyGeralNM_MEDICO: TIBStringField
      FieldName = 'NM_MEDICO'
      Origin = 'MEDICO.NM_MEDICO'
      Size = 50
    end
    object qyGeralMAPAS_VINCULADOS: TIBStringField
      FieldName = 'MAPAS_VINCULADOS'
      Size = 200
    end
    object qyGeralAGENDADOS: TIntegerField
      FieldName = 'AGENDADOS'
    end
    object qyGeralNAO_CONFIRMADOS: TIntegerField
      FieldName = 'NAO_CONFIRMADOS'
    end
    object qyGeralREALIZADO: TLargeintField
      FieldName = 'REALIZADO'
    end
  end
  inherited frxReport1: TfrxReport
    ReportOptions.CreateDate = 41894.334857743100000000
    ReportOptions.LastChange = 42675.345087974540000000
    Left = 80
    Top = 376
    Datasets = <
      item
    ...
    object Page1: TfrxReportPage
      ...
      object ReportTitle1: TfrxReportTitle
        ...
        object Memo3: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8 = (
            'RELAT'#195#8220'RIO PRODUTIVIDADE AGENDAS')
          ParentFont = False
        end
      ...
      object MasterData1: TfrxMasterData
        ...
        object Memo85: TfrxMemoView
          Left = 178.393749610000000000
          Width = 147.401604090000000000
          Height = 17.007874020000000000
          ShowHint = False
          StretchMode = smActualHeight
          DataField = 'MAPAS_VINCULADOS'
          DataSet = frxDBDataset1
          DataSetName = 'frxDBDataset1'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          ...
          Frame.Typ = [ftLeft, ftRight, ftTop, ftBottom]
          Memo.UTF8 = (
            '[frxDBDataset1."MAPAS_VINCULADOS"]')
          ParentFont = False
          VAlign = vaCenter
        end
  ...
  inherited frxDBDataset1: TfrxDBDataset
    FieldAliases.Strings = (
      'NM_MEDICO=NM_MEDICO'
      'MAPAS_VINCULADOS=MAPAS_VINCULADOS'
      'AGENDADOS=AGENDADOS'
