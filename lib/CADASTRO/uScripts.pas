...
begin
  ...
  //Este deve ser adicionado após todos Scripts da Versão
  Insere(Format(cvUpdateDadosVersao,[sVersao]),'Atualiza de Versão do Sistema','');
  ...
  IncluiVersao(Versao,sVersao);
  Insere('', 'Requisita Notificação','PROCREQNOT');
