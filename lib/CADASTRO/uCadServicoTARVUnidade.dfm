inherited frmCadServicosTARVUnidade: TfrmCadServicosTARVUnidade
  Left = 281
  Top = 43
  Caption = 'Relat'#243'rio - TARV Anual / Unidade'
  ClientHeight = 549
  ClientWidth = 1024
  PixelsPerInch = 96
  TextHeight = 13
    ...
    inherited pgGeral: TPageControl
      ...
      inherited tabGeral: TTabSheet
        inherited Panel4: TPanel
          ...
          object sgServicosTARV: TStringGrid
            Left = 1
            Top = 76
            Width = 835
            Height = 371
            ...
            TabOrder = 1
            OnDrawCell = sgServicosTARVDrawCell
            OnSelectCell = sgServicosTARVSelectCell
            OnSetEditText = sgServicosTARVSetEditText
          end
  ...
  inherited dsControle: TDataSource
    DataSet = DMGERAL.TB_SERVICOS_TARV
  end
  ...
  object qyServicosTARV: TIBQuery
    Database = DM.DB
    Transaction = DM.TS
    BufferChunks = 1000
    CachedUpdates = False
  ...
  object qyGrid: TIBQuery
    ...
    SQL.Strings = (
      ...
      '  M.DS_MUNICIPIO,'
      '  P.DS_PROVINCIA'
      'from REGISTRO_SERVICOS_TARV RC'
      '   left outer join MUNICIPIO M on'
      '      RC.CD_MUNICIPIO = M.CD_MUNICIPIO'
      '   left outer join PROVINCIA P on'
      '      RC.CD_PROVINCIA = P.CD_PROVINCIA'
      '   left outer join UNIDADE U on'
      '      RC.CD_UNIDADE = U.CD_UNIDADE'
      'order by   RC.CD_PROVINCIA, RC.CD_UNIDADE'
      ')P')
    Left = 346
    Top = 230
