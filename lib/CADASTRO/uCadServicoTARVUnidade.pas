...
type
  TfrmCadServicosTARVUnidade = class(TfrmCadPadSG)
    Panel5: TPanel;
    Label21: TLabel;
    Label20: TLabel;
    Label1: TLabel;
...
var
  frmCadServicosTARVUnidade: TfrmCadServicosTARVUnidade;
...
procedure TfrmCadServicosTARVUnidade.GeraXML;
...
procedure TfrmCadServicosTARVUnidade.CarregaComboAno;
...
procedure TfrmCadServicosTARVUnidade.CriaGrid;
...
begin
  ...
  sgServicosTARV.FixedCols := 0;
  sgServicosTARV.FixedRows := 2;
  sgServicosTARV.Cells[0,0]  := 'Unidade';
 ...
 sgServicosTARV.Cells[0,12] := 'Total';
  ...
  sgServicosTARV.ColWidths[0] := 200;
...
function TfrmCadServicosTARVUnidade.ValidaExclusao: boolean;
begin
  try
...
procedure TfrmCadServicosTARVUnidade.Varregrid;
var i:integer;
...
procedure TfrmCadServicosTARVUnidade.AbreConsultas;
begin
...
procedure TfrmCadServicosTARVUnidade.FechaConsultas;
begin
  qyProvincia.Close;
  qyMunicipio.Close;
  qyUnidade.Close;
...
procedure TfrmCadServicosTARVUnidade.CalculaTotal;
...
procedure TfrmCadServicosTARVUnidade.CarregaGrid(TB_SERVICOS_TARV:TDataSet);
...
procedure TfrmCadServicosTARVUnidade.FormShow(Sender: TObject);
begin
  inherited;
  qyGrid.Open;
  CriaGrid;
...
procedure TfrmCadServicosTARVUnidade.FormClose(Sender: TObject;
...
procedure TfrmCadServicosTARVUnidade.sgServicosTARVDrawCell(Sender: TObject; ACol,
...
begin
  ...
  //Mesclar: Negrito, Centro, Borda
  if (ARow in [0,1,12]) and (ACol = 0) then
  begin
      if ARow = 0 then
      begin
        Mes[1].gr := Rect;
...
{  //Mesclar: Negrito, Centro, Borda
  ...
  if ((ACol in [0]) and (ARow = sgServicosTARV.RowCount-1))or
...
procedure TfrmCadServicosTARVUnidade.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TfrmCadServicosTARVUnidade.btIncluirClick(Sender: TObject);
begin
  pgGeral.ActivePageIndex := 1;
  dmGeral.TB_SERVICOS_TARV.Close;
  dmGeral.TB_SERVICOS_TARV.Open;
...
procedure TfrmCadServicosTARVUnidade.sgServicosTARVSelectCell(Sender: TObject;
  ACol, ARow: Integer; var CanSelect: Boolean);
var
  i:integer;
begin
...
procedure TfrmCadServicosTARVUnidade.btgravarClick(Sender: TObject);
begin
...
procedure TfrmCadServicosTARVUnidade.sgServicosTARVSetEditText(
...
procedure TfrmCadServicosTARVUnidade.pgGeralChange(Sender: TObject);
//var  i:integer;
begin
  inherited;
{
...
procedure TfrmCadServicosTARVUnidade.btConsultarClick(Sender: TObject);
...
procedure TfrmCadServicosTARVUnidade.grDadosDblClick(Sender: TObject);
begin
...
procedure TfrmCadServicosTARVUnidade.ckConsolidarClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmCadServicosTARVUnidade.cbAnoChange(Sender: TObject);
begin
  inherited;
  sgServicosTARV.Repaint;

end;
procedure TfrmCadServicosTARVUnidade.btexcluirClick(Sender: TObject);
...
procedure TfrmCadServicosTARVUnidade.btLimparClick(Sender: TObject);
begin
  inherited;
  Limpar;
end;

procedure TfrmCadServicosTARVUnidade.btCancelarClick(Sender: TObject);
begin
  if bConsolidado then
  begin
    MessageDlg('Dados em modo de consolidação, não podem ser modificados!',mtInformation,[mbOK],0);
...
procedure TfrmCadServicosTARVUnidade.bteditarClick(Sender: TObject);
begin
  pgGeral.ActivePageIndex := 1;
...
procedure TfrmCadServicosTARVUnidade.btimprimirClick(Sender: TObject);
begin
...
procedure TfrmCadServicosTARVUnidade.Limpar;
begin
  inherited;
  leProvincia.text:='';
  leMunicipio.text:='';
...
procedure TfrmCadServicosTARVUnidade.leProvinciaChange(Sender: TObject);
begin
  inherited;
...
procedure TfrmCadServicosTARVUnidade.leMunicipioChange(Sender: TObject);
begin
  inherited;
...
procedure TfrmCadServicosTARVUnidade.leUnidadeChange(Sender: TObject);
begin
  inherited;
