...
type
  TfrmCadServicoAT = class(TfrmCadPadSG)
    Panel5: TPanel;
    Label21: TLabel;
    Label20: TLabel;
    Label1: TLabel;
...
var
  frmCadServicoAT: TfrmCadServicoAT;
...
procedure TfrmCadServicoAT.GeraXML;
...
procedure TfrmCadServicoAT.CarregaComboAno;
...
procedure TfrmCadServicoAT.CriaGrid;
...
begin
  ...
  sgServicoAT.Cells[3,0]  := '>18m à 4a';
  sgServicoAT.Cells[5,0]  := '5 à 14a';
  sgServicoAT.Cells[7,0]  := '15 à 19a';
  sgServicoAT.Cells[9,0]  := '20 à 29a';
  sgServicoAT.Cells[11,0]  := '30 à 39a';
  sgServicoAT.Cells[13,0]  := '40 à 49a';
  sgServicoAT.Cells[15,0]  := '50 à 59a';
...
function TfrmCadServicoAT.ValidaExclusao: boolean;
begin
  try
...
procedure TfrmCadServicoAT.Varregrid;
var i:integer;
...
procedure TfrmCadServicoAT.AbreConsultas;
begin
...
procedure TfrmCadServicoAT.FechaConsultas;
begin
  qyProvincia.Close;
  qyMunicipio.Close;
  qyUnidade.Close;
...
procedure TfrmCadServicoAT.CalculaTotal;
...
procedure TfrmCadServicoAT.CarregaGrid(TB_SERVICOS_ACOMP:TDataSet);
...
procedure TfrmCadServicoAT.FormShow(Sender: TObject);
begin
  inherited;
  qyGrid.Open;
  CriaGrid;
...
procedure TfrmCadServicoAT.FormClose(Sender: TObject;
...
procedure TfrmCadServicoAT.sgServicoATDrawCell(Sender: TObject; ACol,
...
procedure TfrmCadServicoAT.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TfrmCadServicoAT.btIncluirClick(Sender: TObject);
begin
  pgGeral.ActivePageIndex := 1;
  dmGeral.TB_SERVICOS_ACOMP.Close;
  dmGeral.TB_SERVICOS_ACOMP.Open;
...
procedure TfrmCadServicoAT.sgServicoATSelectCell(Sender: TObject;
  ACol, ARow: Integer; var CanSelect: Boolean);
var
  i:integer;
begin
...
procedure TfrmCadServicoAT.btgravarClick(Sender: TObject);
begin
...
procedure TfrmCadServicoAT.sgServicoATSetEditText(
...
procedure TfrmCadServicoAT.pgGeralChange(Sender: TObject);
//var  i:integer;
begin
  inherited;
{
...
procedure TfrmCadServicoAT.btConsultarClick(Sender: TObject);
...
procedure TfrmCadServicoAT.grDadosDblClick(Sender: TObject);
begin
...
procedure TfrmCadServicoAT.ckConsolidarClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmCadServicoAT.cbAnoChange(Sender: TObject);
begin
  inherited;
  sgServicoAT.Repaint;

end;
procedure TfrmCadServicoAT.btexcluirClick(Sender: TObject);
...
procedure TfrmCadServicoAT.btLimparClick(Sender: TObject);
begin
  inherited;
  Limpar;
end;

procedure TfrmCadServicoAT.btCancelarClick(Sender: TObject);
begin
  if bConsolidado then
  begin
    MessageDlg('Dados em modo de consolidação, não podem ser modificados!',mtInformation,[mbOK],0);
...
procedure TfrmCadServicoAT.bteditarClick(Sender: TObject);
begin
  pgGeral.ActivePageIndex := 1;
...
procedure TfrmCadServicoAT.btimprimirClick(Sender: TObject);
begin
...
procedure TfrmCadServicoAT.Limpar;
begin
  inherited;
  leProvincia.text:='';
  leMunicipio.text:='';
...
procedure TfrmCadServicoAT.leProvinciaChange(Sender: TObject);
begin
  inherited;
...
procedure TfrmCadServicoAT.leMunicipioChange(Sender: TObject);
begin
  inherited;
...
procedure TfrmCadServicoAT.leUnidadeChange(Sender: TObject);
begin
  inherited;
