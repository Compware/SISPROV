inherited frmCadServicoATUnidade: TfrmCadServicoATUnidade
  Left = 197
  Top = 52
  Caption = 'Relat'#243'rio - Acompanhamento Anual / Unidade'
  ClientHeight = 520
  ClientWidth = 956
  PixelsPerInch = 96
  TextHeight = 13
    ...
    inherited pgGeral: TPageControl
      ...
      inherited tabGeral: TTabSheet
        inherited Panel4: TPanel
          ...
          object sgServicoAT: TStringGrid
            Left = 1
            Top = 76
            Width = 767
            Height = 342
            ...
            TabOrder = 1
            OnDrawCell = sgServicoATDrawCell
            OnSelectCell = sgServicoATSelectCell
            OnSetEditText = sgServicoATSetEditText
          end
  ...
  inherited dsControle: TDataSource
    DataSet = DMGERAL.TB_SERVICOS_ACOMP
  end
  ...
  object qyGrid: TIBQuery
    ...
    SQL.Strings = (
      ...
      '  M.DS_MUNICIPIO,'
      '  P.DS_PROVINCIA'
      'from REGISTRO_SERVICOS_ACOMP RC'
