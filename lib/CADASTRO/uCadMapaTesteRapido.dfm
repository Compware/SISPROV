inherited frmCadMapaTesteRapido: TfrmCadMapaTesteRapido
  Left = 18
  Top = 100
  Caption = 'Mapa Teste Rapido'
  ClientHeight = 560
  ClientWidth = 1328
  OldCreateOrder = True
  PixelsPerInch = 96
    ...
    inherited pgGeral: TPageControl
      ...
      inherited tabLista: TTabSheet
        inherited Panel3: TPanel
          ...
          inherited grDados: TdxDBGrid
            ...
            object gcDS_PROVINCIA: TdxDBGridColumn
              Caption = 'Provincia'
              Width = 177
              BandIndex = 0
              RowIndex = 0
            ...
            object grDS_MUNICIPIO: TdxDBGridColumn
            ...
            object grDS_UNIDADE: TdxDBGridColumn
              Caption = 'Unidade'
              Width = 304
              BandIndex = 0
              RowIndex = 0
      ...
      inherited tabGeral: TTabSheet
        inherited Panel4: TPanel
          ...
          object grMapaMedico: TdxDBGrid
            ...
            object gcNR_IDADE: TdxDBGridColumn
              Caption = 'Idade'
              HeaderAlignment = taCenter
              Width = 101
              BandIndex = 0
            ...
            object gcVL_RESULTADO_DETERMINE: TdxDBGridPickColumn
              Caption = 'Determine'
              HeaderAlignment = taCenter
              MinWidth = 16
              Width = 120
              BandIndex = 1
              RowIndex = 0
              FieldName = 'VL_RESULTADO_DETERMINE'
              Items.Strings = (
                'N'#195'O REACTIVO'
                'REATIVO'
                'INVALIDO'
            ...
            object gcVL_RESULTADO_UNIGOLD: TdxDBGridPickColumn
              Caption = 'Unigold'
              HeaderAlignment = taCenter
              MinWidth = 16
              Width = 120
              BandIndex = 1
              RowIndex = 0
              FieldName = 'VL_RESULTADO_UNIGOLD'
              Items.Strings = (
                'N'#195'O REACTIVO'
                'REATIVO'
                'INVALIDO'
            ...
            object gcVL_RESULTADO_FINAL: TdxDBGridPickColumn
              Caption = 'Final'
              HeaderAlignment = taCenter
              MinWidth = 16
              Width = 120
            ...
            object gcVL_RESULTADO_CONFIRMATORIO: TdxDBGridPickColumn
              Caption = 'Confirmat'#243'rio'
              HeaderAlignment = taCenter
              Width = 120
              BandIndex = 1
              RowIndex = 0
              FieldName = 'VL_RESULTADO_CONFIRMATORIO'
              Items.Strings = (
                'POSITIVO'
                'NEGATIVO'
                'INDETERMINADO'
            ...
            object gcDS_OBSERVACAO: TdxDBGridColumn
              Caption = 'Observa'#231#227'o'
              HeaderAlignment = taCenter
              Width = 280
              BandIndex = 2
      ...
      object tabExport: TTabSheet
        ...
        object grExport: TdxDBGrid
          ...
          ShowBands = True
          ShowRowFooter = True
          object grExportColumn12: TdxDBGridColumn
            Caption = 'Todos'
            Sorted = csUp
            Visible = False
            Width = 58
          ...
          object grExportColumn13: TdxDBGridDateColumn
            Caption = 'Data Mapa'
            Width = 85
            BandIndex = 0
            RowIndex = 0
          ...
          object dxDBGridPickColumn3: TdxDBGridPickColumn
            Caption = 'Final'
            HeaderAlignment = taCenter
            MinWidth = 16
            Width = 133
          ...
          object dxDBGridPickColumn4: TdxDBGridPickColumn
            Caption = 'Confirmat'#243'rio'
            HeaderAlignment = taCenter
            Width = 101
            BandIndex = 1
  ...
  object qyGrid: TIBQuery [5]
    ...
    SQL.Strings = (
      'select '
      '      "MAPA_TESTE_RAPIDO"."CD_UNIDADE"'
      '      ,"MAPA_TESTE_RAPIDO"."CD_MAPA"'
      '      ,"MAPA_TESTE_RAPIDO"."DT_MAPA"'
      '      , UNIDADE.DS_UNIDADE'
      '      , MUNICIPIO.DS_MUNICIPIO'
      '      , PROVINCIA.DS_PROVINCIA'
      'from "MAPA_TESTE_RAPIDO"'
      '  left outer join   UNIDADE on'
      '  MAPA_TESTE_RAPIDO.CD_UNIDADE    =  UNIDADE.CD_UNIDADE  '
    ...
    object qyGridCD_UNIDADE: TIntegerField
      ...
      Origin = 'MAPA_TESTE_RAPIDO.CD_UNIDADE'
    end
    object qyGridDT_MAPA: TDateTimeField
      FieldName = 'DT_MAPA'
      Origin = 'MAPA_TESTE_RAPIDO.DT_MAPA'
    end
    ...
    object qyGridCD_MAPA: TIntegerField
      FieldName = 'CD_MAPA'
      Origin = 'MAPA_TESTE_RAPIDO.CD_MAPA'
      Required = True
    end
  end
  ...
  object dsMapaLinha: TDataSource
    AutoEdit = False
    DataSet = TB_MAPA_TESTE_RAPIDO_PACIENTE
  ...
  object fxMapa: TfrxReport
    ...
    ReportOptions.LastChange = 42469.581376585650000000
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object Memo20: TfrxMemoView
          ...
          Height = 22.677180000000000000
          ShowHint = False
          DataField = 'VL_RESULTADO_CONFIRMATORIO'
          DataSet = fxdbPaciente
          DataSetName = 'Paciente'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          ...
          Font.Style = []
          Memo.UTF8 = (
            '[Paciente."VL_RESULTADO_CONFIRMATORIO"]')
          ParentFont = False
          VAlign = vaCenter
        end
        ...
        object Memo22: TfrxMemoView
          ...
          Height = 22.677165350000000000
          ShowHint = False
          DataField = 'VL_RESULTADO_DETERMINE'
          DataSet = fxdbPaciente
          DataSetName = 'Paciente'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          ...
          Font.Style = []
          Memo.UTF8 = (
            '[Paciente."VL_RESULTADO_DETERMINE"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo26: TfrxMemoView
          Left = 433.323130000000000000
          Top = 4.000000000000000000
          Width = 86.929190000000000000
          Height = 22.677180000000000000
          ShowHint = False
          DataField = 'VL_RESULTADO_UNIGOLD'
          DataSet = fxdbPaciente
          DataSetName = 'Paciente'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          ...
          Font.Style = []
          Memo.UTF8 = (
            '[Paciente."VL_RESULTADO_UNIGOLD"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo27: TfrxMemoView
          Left = 526.811380000000000000
          Top = 4.000000000000000000
          Width = 86.929190000000000000
          Height = 22.677180000000000000
          ShowHint = False
          DataField = 'VL_RESULTADO_FINAL'
          DataSet = fxdbPaciente
          DataSetName = 'Paciente'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
  ...
  object TB_MAPA_TESTE_RAPIDO: TIBDataSet
    Database = DM.DB
    Transaction = DM.TS
    AfterInsert = TB_MAPA_TESTE_RAPIDOAfterInsert
    AfterOpen = TB_MAPA_TESTE_RAPIDOAfterOpen
    BeforeClose = TB_MAPA_TESTE_RAPIDOBeforeClose
    BeforeDelete = TB_MAPA_TESTE_RAPIDOBeforeDelete
    BeforePost = TB_MAPA_TESTE_RAPIDOBeforePost
    BufferChunks = 1000
    CachedUpdates = False
    DeleteSQL.Strings = (
      'delete from "MAPA_TESTE_RAPIDO"'
      'where'
      '  "CD_MAPA" = :"OLD_CD_MAPA"')
    InsertSQL.Strings = (
      'insert into "MAPA_TESTE_RAPIDO"'
      '('
      '  "CD_MAPA"'
      ', "CD_UNIDADE"'
      ', "CD_MEDICO"'
      ...
      ')')
    SelectSQL.Strings = (
      'select "MAPA_TESTE_RAPIDO"."CD_MAPA"'
      '      ,"MAPA_TESTE_RAPIDO"."CD_UNIDADE"'
      '      ,"MAPA_TESTE_RAPIDO"."DT_MAPA"'
      '      ,"MAPA_TESTE_RAPIDO"."CD_MEDICO"'
      '      , UNIDADE.DS_UNIDADE'
      '      , MUNICIPIO.DS_MUNICIPIO'
      '      , PROVINCIA.DS_PROVINCIA'
      '      , MEDICO.NM_MEDICO'
      ...
      '  MEDICO.CD_MEDICO = "MAPA_TESTE_RAPIDO"."CD_MEDICO"'
      'where  '
      '  "MAPA_TESTE_RAPIDO"."DT_MAPA" = :DT_MAPA')
    ModifySQL.Strings = (
      'update "MAPA_TESTE_RAPIDO"'
      'set'
      ' "CD_MAPA" = :"CD_MAPA"'
    ...
    GeneratorField.Generator = 'GEN_MAPA_TESTE_RAPIDO'
    Left = 1048
    Top = 235
    object TB_MAPA_TESTE_RAPIDOCD_MAPA: TIntegerField
      FieldName = 'CD_MAPA'
      Origin = 'MAPA_TESTE_RAPIDO.CD_MAPA'
      Required = True
    end
    object TB_MAPA_TESTE_RAPIDOCD_UNIDADE: TIntegerField
      FieldName = 'CD_UNIDADE'
      Origin = 'MAPA_TESTE_RAPIDO.CD_UNIDADE'
    end
    object TB_MAPA_TESTE_RAPIDODT_MAPA: TDateTimeField
      FieldName = 'DT_MAPA'
      Origin = 'MAPA_TESTE_RAPIDO.DT_MAPA'
      OnValidate = TB_MAPA_TESTE_RAPIDODT_MAPAValidate
    end
    object TB_MAPA_TESTE_RAPIDODS_UNIDADE: TIBStringField
      FieldName = 'DS_UNIDADE'
      Origin = 'UNIDADE.DS_UNIDADE'
      Size = 50
    end
    object TB_MAPA_TESTE_RAPIDODS_MUNICIPIO: TIBStringField
      FieldName = 'DS_MUNICIPIO'
      Origin = 'MUNICIPIO.DS_MUNICIPIO'
      Size = 50
    end
    object TB_MAPA_TESTE_RAPIDODS_PROVINCIA: TIBStringField
      FieldName = 'DS_PROVINCIA'
      Origin = 'PROVINCIA.DS_PROVINCIA'
      Size = 50
    end
    object TB_MAPA_TESTE_RAPIDOCD_MEDICO: TIntegerField
      FieldName = 'CD_MEDICO'
      Origin = 'MAPA_TESTE_RAPIDO.CD_MEDICO'
      OnValidate = TB_MAPA_TESTE_RAPIDOCD_MEDICOValidate
    end
    object TB_MAPA_TESTE_RAPIDONM_MEDICO: TIBStringField
      FieldName = 'NM_MEDICO'
      Origin = 'MEDICO.NM_MEDICO'
      Size = 50
    end
  end
  object TB_MAPA_TESTE_RAPIDO_PACIENTE: TIBDataSet
    Database = DM.DB
    Transaction = DM.TS
    AfterInsert = TB_MAPA_TESTE_RAPIDO_PACIENTEAfterInsert
    BeforeInsert = TB_MAPA_TESTE_RAPIDO_PACIENTEBeforeInsert
    BeforePost = TB_MAPA_TESTE_RAPIDO_PACIENTEBeforePost
    OnCalcFields = TB_MAPA_TESTE_RAPIDO_PACIENTECalcFields
    BufferChunks = 1000
    CachedUpdates = False
    DeleteSQL.Strings = (
      'delete from "MAPA_TESTE_RAPIDO_PACIENTE"'
      'where'
      '  "CD_MAPA_PACIENTE" = :"OLD_CD_MAPA_PACIENTE"')
    InsertSQL.Strings = (
      'insert into "MAPA_TESTE_RAPIDO_PACIENTE"'
      '('
      '  "CD_MAPA_PACIENTE"'
      ', "CD_MAPA"'
      ', "CD_AGENDA"'
      ...
      ', "NR_IDADE"'
      ', "TP_EXAME"'
      ', "VL_RESULTADO_DETERMINE"'
      ', "VL_RESULTADO_UNIGOLD"'
      ', "VL_RESULTADO_FINAL"'
      ', "VL_RESULTADO_CONFIRMATORIO"'
      ', "DS_OBSERVACAO"'
      ', "CD_TECNICO"'
      ', "NR_PROCESSO"'
      ')'
      ...
      ')')
    SelectSQL.Strings = (
      'select "MAPA_TESTE_RAPIDO_PACIENTE"."CD_MAPA_PACIENTE"'
      '      ,"MAPA_TESTE_RAPIDO_PACIENTE"."CD_MAPA"'
      '      ,"MAPA_TESTE_RAPIDO_PACIENTE"."CD_AGENDA"'
      '      ,"MAPA_TESTE_RAPIDO_PACIENTE"."CD_PACIENTE"'
      '      ,"MAPA_TESTE_RAPIDO_PACIENTE"."NM_PACIENTE"'
      '      ,"MAPA_TESTE_RAPIDO_PACIENTE"."FL_SEXO"'
      '      ,"MAPA_TESTE_RAPIDO_PACIENTE"."NR_IDADE"'
      '      ,"MAPA_TESTE_RAPIDO_PACIENTE"."DS_OBSERVACAO"'
      '      ,"MAPA_TESTE_RAPIDO_PACIENTE"."CD_TECNICO"'
      '      ,"MAPA_TESTE_RAPIDO_PACIENTE"."NR_PROCESSO"'
      '      ,"MAPA_TESTE_RAPIDO_PACIENTE"."TP_EXAME"'
      '      ,"MAPA_TESTE_RAPIDO_PACIENTE"."VL_RESULTADO_DETERMINE"'
      '      ,"MAPA_TESTE_RAPIDO_PACIENTE"."VL_RESULTADO_UNIGOLD"'
      '      ,"MAPA_TESTE_RAPIDO_PACIENTE"."VL_RESULTADO_FINAL"'
      '      ,"MAPA_TESTE_RAPIDO_PACIENTE"."VL_RESULTADO_CONFIRMATORIO"'
      '      , NM_INVESTIGADOR'
      'from "MAPA_TESTE_RAPIDO_PACIENTE"'
      ' LEFT OUTER JOIN  INVESTIGADOR'
      ' ON  CD_INVESTIGADOR = "MAPA_TESTE_RAPIDO_PACIENTE"."CD_TECNICO"'
      'where '
      '"MAPA_TESTE_RAPIDO_PACIENTE"."CD_MAPA" = :CD_MAPA')
    ModifySQL.Strings = (
      'update "MAPA_TESTE_RAPIDO_PACIENTE"'
      'set'
      ' "CD_MAPA_PACIENTE" = :"CD_MAPA_PACIENTE"'
      ', "CD_MAPA" = :"CD_MAPA"'
      ', "CD_AGENDA" = :"CD_AGENDA"'
      ...
      ', "NR_IDADE" = :"NR_IDADE"'
      ', "TP_EXAME" = :"TP_EXAME"'
      ', "VL_RESULTADO_DETERMINE" = :"VL_RESULTADO_DETERMINE"'
      ', "VL_RESULTADO_UNIGOLD" = :"VL_RESULTADO_UNIGOLD"'
      ', "VL_RESULTADO_FINAL" = :"VL_RESULTADO_FINAL"'
      ', "VL_RESULTADO_CONFIRMATORIO" = :"VL_RESULTADO_CONFIRMATORIO"'
      ', "DS_OBSERVACAO" = :"DS_OBSERVACAO"'
      ', "CD_TECNICO" = :"CD_TECNICO"'
      ', "NR_PROCESSO" = :"NR_PROCESSO"'
      'where'
      '  "CD_MAPA_PACIENTE" = :"OLD_CD_MAPA_PACIENTE"')
    GeneratorField.Field = 'CD_MAPA_PACIENTE'
    GeneratorField.Generator = 'GEN_TESTE_RAPIDO_PACIENTE'
    GeneratorField.ApplyEvent = gamOnPost
    DataSource = dsMapaLab
    Left = 1048
    Top = 267
    object TB_MAPA_TESTE_RAPIDO_PACIENTECD_MAPA_PACIENTE: TIntegerField
      FieldName = 'CD_MAPA_PACIENTE'
      Origin = 'MAPA_TESTE_RAPIDO_PACIENTE.CD_MAPA_PACIENTE'
      Required = True
    end
    object TB_MAPA_TESTE_RAPIDO_PACIENTECD_MAPA: TIntegerField
      FieldName = 'CD_MAPA'
      Origin = 'MAPA_TESTE_RAPIDO_PACIENTE.CD_MAPA'
      Required = True
    end
    object TB_MAPA_TESTE_RAPIDO_PACIENTECD_PACIENTE: TIntegerField
      FieldName = 'CD_PACIENTE'
      Origin = 'MAPA_TESTE_RAPIDO_PACIENTE.CD_PACIENTE'
    end
    object TB_MAPA_TESTE_RAPIDO_PACIENTENM_PACIENTE: TIBStringField
      FieldName = 'NM_PACIENTE'
      Origin = 'MAPA_TESTE_RAPIDO_PACIENTE.NM_PACIENTE'
      Size = 100
    end
    object TB_MAPA_TESTE_RAPIDO_PACIENTEFL_SEXO: TIBStringField
      FieldName = 'FL_SEXO'
      Origin = 'MAPA_TESTE_RAPIDO_PACIENTE.FL_SEXO'
      FixedChar = True
      Size = 1
    end
    object TB_MAPA_TESTE_RAPIDO_PACIENTENR_IDADE: TIntegerField
      FieldName = 'NR_IDADE'
      Origin = 'MAPA_TESTE_RAPIDO_PACIENTE.NR_IDADE'
    end
    object TB_MAPA_TESTE_RAPIDO_PACIENTEDS_OBSERVACAO: TIBStringField
      FieldName = 'DS_OBSERVACAO'
      Origin = 'MAPA_TESTE_RAPIDO_PACIENTE.DS_OBSERVACAO'
      Size = 200
    end
    object TB_MAPA_TESTE_RAPIDO_PACIENTECD_TECNICO: TIntegerField
      FieldName = 'CD_TECNICO'
      Origin = 'MAPA_TESTE_RAPIDO_PACIENTE.CD_TECNICO'
    end
    object TB_MAPA_TESTE_RAPIDO_PACIENTENM_INVESTIGADOR: TIBStringField
      FieldName = 'NM_INVESTIGADOR'
      Origin = 'INVESTIGADOR.NM_INVESTIGADOR'
      Size = 50
    end
    object TB_MAPA_TESTE_RAPIDO_PACIENTECODIGO: TIntegerField
      FieldKind = fkCalculated
      FieldName = 'CODIGO'
      Calculated = True
    end
    object TB_MAPA_TESTE_RAPIDO_PACIENTENR_PROCESSO: TIBStringField
      FieldName = 'NR_PROCESSO'
      Origin = 'MAPA_TESTE_RAPIDO_PACIENTE.NR_PROCESSO'
      OnValidate = TB_MAPA_TESTE_RAPIDO_PACIENTENR_PROCESSOValidate
      Size = 15
    end
    object TB_MAPA_TESTE_RAPIDO_PACIENTETP_EXAME: TIBStringField
      FieldName = 'TP_EXAME'
      Origin = 'MAPA_TESTE_RAPIDO_PACIENTE.TP_EXAME'
      FixedChar = True
      Size = 1
    end
    object TB_MAPA_TESTE_RAPIDO_PACIENTEVL_RESULTADO_DETERMINE: TIBStringField
      FieldName = 'VL_RESULTADO_DETERMINE'
      Origin = 'MAPA_TESTE_RAPIDO_PACIENTE.VL_RESULTADO_DETERMINE'
    end
    object TB_MAPA_TESTE_RAPIDO_PACIENTEVL_RESULTADO_UNIGOLD: TIBStringField
      FieldName = 'VL_RESULTADO_UNIGOLD'
      Origin = 'MAPA_TESTE_RAPIDO_PACIENTE.VL_RESULTADO_UNIGOLD'
    end
    object TB_MAPA_TESTE_RAPIDO_PACIENTEVL_RESULTADO_FINAL: TIBStringField
      FieldName = 'VL_RESULTADO_FINAL'
      Origin = 'MAPA_TESTE_RAPIDO_PACIENTE.VL_RESULTADO_FINAL'
    end
    object TB_MAPA_TESTE_RAPIDO_PACIENTEVL_RESULTADO_CONFIRMATORIO: TIBStringField
      FieldName = 'VL_RESULTADO_CONFIRMATORIO'
      Origin = 'MAPA_TESTE_RAPIDO_PACIENTE.VL_RESULTADO_CONFIRMATORIO'
    end
    object TB_MAPA_TESTE_RAPIDO_PACIENTECD_AGENDA: TIntegerField
      FieldName = 'CD_AGENDA'
      Origin = 'MAPA_TESTE_RAPIDO_PACIENTE.CD_AGENDA'
    end
  end
  object dsMapaLab: TDataSource
    AutoEdit = False
    DataSet = TB_MAPA_TESTE_RAPIDO
    Left = 1048
    Top = 300
  ...
  object qyExport: TIBQuery
    ...
    SQL.Strings = (
      ...
      '     , "MAPA_TESTE_RAPIDO"."CD_UNIDADE"'
      '      ,"MAPA_TESTE_RAPIDO"."DT_MAPA"'
      '      ,"MAPA_TESTE_RAPIDO_PACIENTE"."CD_MAPA_PACIENTE"'
      '      ,"MAPA_TESTE_RAPIDO_PACIENTE"."CD_MAPA"'
      '      ,"MAPA_TESTE_RAPIDO_PACIENTE"."CD_PACIENTE"'
      '      ,"MAPA_TESTE_RAPIDO_PACIENTE"."NM_PACIENTE"'
      '      ,"MAPA_TESTE_RAPIDO_PACIENTE"."FL_SEXO"'
      ...
      ' LEFT OUTER JOIN  INVESTIGADOR'
      ' ON  CD_INVESTIGADOR = "MAPA_TESTE_RAPIDO_PACIENTE"."CD_TECNICO"'
      ' INNER JOIN "MAPA_TESTE_RAPIDO"'
      
        ' ON "MAPA_TESTE_RAPIDO_PACIENTE"."CD_MAPA" = "MAPA_TESTE_RAPIDO"' +
        '."CD_MAPA"'
      'order by       "MAPA_TESTE_RAPIDO"."DT_MAPA" desc')
    Left = 354
    Top = 286
  end
