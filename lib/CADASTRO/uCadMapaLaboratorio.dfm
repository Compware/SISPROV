inherited frmCadMapaLaboratorio: TfrmCadMapaLaboratorio
  Left = 29
  Top = 110
    ...
    inherited pgGeral: TPageControl
      ...
      inherited tabGeral: TTabSheet
        inherited Panel4: TPanel
          ...
          object grMapaMedico: TdxDBGrid
            ...
            object gcTP_EXAME_CD4: TdxDBGridCheckColumn
              Caption = 'CD4'
              ...
              BandIndex = 1
              RowIndex = 0
              FieldName = 'TP_EXAME_CD4'
              ValueChecked = 'S'
              ValueUnchecked = 'N'
            end
            object gcTP_EXAME_CV: TdxDBGridCheckColumn
              Caption = 'CV'
              DisableDragging = True
              HeaderAlignment = taCenter
              Width = 39
              BandIndex = 1
              RowIndex = 0
              FieldName = 'TP_EXAME_CV'
              ValueChecked = 'S'
              ValueUnchecked = 'N'
            end
            object gcTP_EXAME_DPI: TdxDBGridCheckColumn
              Caption = 'DPI'
              DisableDragging = True
              HeaderAlignment = taCenter
              Width = 44
              BandIndex = 1
              RowIndex = 0
              FieldName = 'TP_EXAME_DPI'
              ValueChecked = 'S'
              ValueUnchecked = 'N'
            end
            object gcTP_EXAME_TB: TdxDBGridCheckColumn
              Caption = 'TB'
              DisableDragging = True
              HeaderAlignment = taCenter
              Width = 39
              BandIndex = 1
              RowIndex = 0
              FieldName = 'TP_EXAME_TB'
              ValueChecked = 'S'
              ValueUnchecked = 'N'
            end
            object gcVL_RESULTADO: TdxDBGridPickColumn
              Caption = 'Resultado'
              HeaderAlignment = taCenter
              Width = 80
              BandIndex = 1
            ...
            object gcDT_RESULTADO: TdxDBGridDateColumn
            ...
            object gcNR_LAB: TdxDBGridColumn
              Caption = 'Nr. Lab.'
              Width = 69
              BandIndex = 1
              RowIndex = 0
            ...
            object gcTIPO_EXAME: TdxDBGridColumn
              Caption = 'Tipo Exame'
              Sorted = csUp
              Visible = False
              BandIndex = 0
      ...
      object tabExport: TTabSheet
        ...
        object grExport: TdxDBGrid
          ...
          object grExportColumn14: TdxDBGridDateColumn
            Caption = 'Data Mapa'
            Width = 85
            BandIndex = 0
            RowIndex = 0
          ...
          object grExportColumn17: TdxDBGridDateColumn
            Caption = 'Data Resultado'
            Width = 110
            BandIndex = 1
            RowIndex = 0
  ...
  object fxMapa: TfrxReport
    ...
    ReportOptions.LastChange = 42653.354893750000000000
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object Memo25: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8 = (
            '[Paciente."TP_EXAME_CV"]')
          ParentFont = False
          VAlign = vaCenter
        end
        object Memo26: TfrxMemoView
          Left = 449.323130000000000000
          Top = 1.999975590000000000
          Width = 34.015770000000000000
          Height = 26.456710000000000000
          ShowHint = False
          DataField = 'TP_EXAME_DPI'
          DataSet = fxdbPaciente
          DataSetName = 'Paciente'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
  ...
  object TB_MAPA_LAB: TIBDataSet
    Database = DM.DB
    Transaction = DM.TS
    AfterInsert = TB_MAPA_LABAfterInsert
    AfterOpen = TB_MAPA_LABAfterOpen
    BeforeClose = TB_MAPA_LABBeforeClose
    BeforeDelete = TB_MAPA_LABBeforeDelete
    BeforePost = TB_MAPA_LABBeforePost
    BufferChunks = 1000
    CachedUpdates = False
    DeleteSQL.Strings = (
      'delete from "MAPA_LAB"'
      'where'
      '  "CD_MAPA" = :"OLD_CD_MAPA"')
    InsertSQL.Strings = (
      'insert into "MAPA_LAB"'
      '('
      '  "CD_MAPA"'
      ', "CD_UNIDADE"'
      ', "CD_MEDICO"'
    ...
    SelectSQL.Strings = (
      ...
      '  MEDICO.CD_MEDICO = "MAPA_LAB"."CD_MEDICO"'
      'where  '
      '  "MAPA_LAB"."DT_MAPA" = :DT_MAPA'
      '  AND "MAPA_LAB"."CD_MEDICO" = :CD_MEDICO')
    ModifySQL.Strings = (
      'update "MAPA_LAB"'
      'set'
      ' "CD_MAPA" = :"CD_MAPA"'
    ...
    GeneratorField.Generator = 'GEN_MAPA_LAB'
    Left = 1048
    Top = 235
    object TB_MAPA_LABCD_MAPA: TIntegerField
      FieldName = 'CD_MAPA'
      Origin = 'MAPA_LAB.CD_MAPA'
      Required = True
    end
    object TB_MAPA_LABCD_UNIDADE: TIntegerField
      FieldName = 'CD_UNIDADE'
      Origin = 'MAPA_LAB.CD_UNIDADE'
    end
    object TB_MAPA_LABDT_MAPA: TDateTimeField
      FieldName = 'DT_MAPA'
      Origin = 'MAPA_LAB.DT_MAPA'
      OnValidate = TB_MAPA_LABDT_MAPAValidate
    end
    object TB_MAPA_LABDS_UNIDADE: TIBStringField
      FieldName = 'DS_UNIDADE'
      Origin = 'UNIDADE.DS_UNIDADE'
      Size = 50
    end
    object TB_MAPA_LABDS_MUNICIPIO: TIBStringField
      FieldName = 'DS_MUNICIPIO'
      Origin = 'MUNICIPIO.DS_MUNICIPIO'
      Size = 50
    end
    object TB_MAPA_LABDS_PROVINCIA: TIBStringField
      FieldName = 'DS_PROVINCIA'
      Origin = 'PROVINCIA.DS_PROVINCIA'
      Size = 50
    end
    object TB_MAPA_LABCD_MEDICO: TIntegerField
      FieldName = 'CD_MEDICO'
      Origin = 'MAPA_LAB.CD_MEDICO'
      OnValidate = TB_MAPA_LABCD_MEDICOValidate
    end
    object TB_MAPA_LABNM_MEDICO: TIBStringField
      FieldName = 'NM_MEDICO'
      Origin = 'MEDICO.NM_MEDICO'
      Size = 50
    end
  end
  object TB_MAPA_LAB_PACIENTE: TIBDataSet
    Database = DM.DB
    Transaction = DM.TS
    AfterInsert = TB_MAPA_LAB_PACIENTEAfterInsert
    BeforeInsert = TB_MAPA_LAB_PACIENTEBeforeInsert
    BeforePost = TB_MAPA_LAB_PACIENTEBeforePost
    OnCalcFields = TB_MAPA_LAB_PACIENTECalcFields
    BufferChunks = 1000
    CachedUpdates = False
    DeleteSQL.Strings = (
      'delete from "MAPA_LAB_PACIENTE"'
      'where'
      '  "CD_MAPA_PACIENTE" = :"OLD_CD_MAPA_PACIENTE"')
    InsertSQL.Strings = (
      'insert into "MAPA_LAB_PACIENTE"'
      '('
      '  "CD_MAPA_PACIENTE"'
      ', "CD_MAPA"'
      ', "CD_PACIENTE"'
      ...
      ')')
    SelectSQL.Strings = (
      'select "MAPA_LAB_PACIENTE"."CD_MAPA_PACIENTE"'
      '      ,"MAPA_LAB_PACIENTE"."CD_MAPA"'
      '      ,"MAPA_LAB_PACIENTE"."CD_AGENDA"'
      '      ,"MAPA_LAB_PACIENTE"."CD_PACIENTE"'
      '      ,"MAPA_LAB_PACIENTE"."NM_PACIENTE"'
      '      ,"MAPA_LAB_PACIENTE"."FL_SEXO"'
      '      ,"MAPA_LAB_PACIENTE"."NR_IDADE"'
      '      ,"MAPA_LAB_PACIENTE"."VL_RESULTADO"'
      '      ,"MAPA_LAB_PACIENTE"."DS_OBSERVACAO"'
      '      ,"MAPA_LAB_PACIENTE"."CD_TECNICO"'
      '      ,"MAPA_LAB_PACIENTE"."NR_PROCESSO"'
      '      ,"MAPA_LAB_PACIENTE"."TP_EXAME_CD4"'
      '      ,"MAPA_LAB_PACIENTE"."TP_EXAME_CV"'
      '      ,"MAPA_LAB_PACIENTE"."TP_EXAME_DPI"'
      '      ,"MAPA_LAB_PACIENTE"."TP_EXAME_TB"'
      '      ,"MAPA_LAB_PACIENTE"."NR_LAB"'
      '      ,"MAPA_LAB_PACIENTE"."DT_RESULTADO"'
      '      , NM_INVESTIGADOR'
      'from "MAPA_LAB_PACIENTE"'
      ' LEFT OUTER JOIN  INVESTIGADOR'
      ' ON  CD_INVESTIGADOR = "MAPA_LAB_PACIENTE"."CD_TECNICO"'
      'where '
      '"MAPA_LAB_PACIENTE"."CD_MAPA" = :CD_MAPA')
    ModifySQL.Strings = (
      'update "MAPA_LAB_PACIENTE"'
      'set'
      ...
      ', "TP_EXAME_CD4" = :"TP_EXAME_CD4"'
      ', "TP_EXAME_CV" = :"TP_EXAME_CV"'
      ', "TP_EXAME_DPI" = :"TP_EXAME_DPI"'
      ', "TP_EXAME_TB" = :"TP_EXAME_TB"'
      ', "CD_AGENDA" = :"CD_AGENDA"'
      ', "NR_LAB" = :"NR_LAB"'
    ...
    GeneratorField.Generator = 'GEN_MAPA_LAB_PACIENTE'
    DataSource = dsMapaLab
    Left = 1048
    Top = 267
    object TB_MAPA_LAB_PACIENTECD_MAPA_PACIENTE: TIntegerField
      FieldName = 'CD_MAPA_PACIENTE'
      Origin = 'MAPA_LAB_PACIENTE.CD_MAPA_PACIENTE'
      Required = True
    end
    object TB_MAPA_LAB_PACIENTECD_MAPA: TIntegerField
      FieldName = 'CD_MAPA'
      Origin = 'MAPA_LAB_PACIENTE.CD_MAPA'
      Required = True
    end
    object TB_MAPA_LAB_PACIENTECD_PACIENTE: TIntegerField
      FieldName = 'CD_PACIENTE'
      Origin = 'MAPA_LAB_PACIENTE.CD_PACIENTE'
    end
    object TB_MAPA_LAB_PACIENTENM_PACIENTE: TIBStringField
      FieldName = 'NM_PACIENTE'
      Origin = 'MAPA_LAB_PACIENTE.NM_PACIENTE'
      Size = 100
    end
    object TB_MAPA_LAB_PACIENTEFL_SEXO: TIBStringField
      FieldName = 'FL_SEXO'
      Origin = 'MAPA_LAB_PACIENTE.FL_SEXO'
      FixedChar = True
      Size = 1
    end
    object TB_MAPA_LAB_PACIENTENR_IDADE: TIntegerField
      FieldName = 'NR_IDADE'
      Origin = 'MAPA_LAB_PACIENTE.NR_IDADE'
    end
    object TB_MAPA_LAB_PACIENTEVL_RESULTADO: TIBStringField
      FieldName = 'VL_RESULTADO'
      Origin = 'MAPA_LAB_PACIENTE.VL_RESULTADO'
      Size = 50
    end
    object TB_MAPA_LAB_PACIENTEDS_OBSERVACAO: TIBStringField
      FieldName = 'DS_OBSERVACAO'
      Origin = 'MAPA_LAB_PACIENTE.DS_OBSERVACAO'
      Size = 200
    end
    object TB_MAPA_LAB_PACIENTECD_TECNICO: TIntegerField
      FieldName = 'CD_TECNICO'
      Origin = 'MAPA_LAB_PACIENTE.CD_TECNICO'
    end
    object TB_MAPA_LAB_PACIENTENM_INVESTIGADOR: TIBStringField
      FieldName = 'NM_INVESTIGADOR'
      Origin = 'INVESTIGADOR.NM_INVESTIGADOR'
      Size = 50
    end
    object TB_MAPA_LAB_PACIENTECODIGO: TIntegerField
      FieldKind = fkCalculated
      FieldName = 'CODIGO'
      Calculated = True
    end
    object TB_MAPA_LAB_PACIENTENR_PROCESSO: TIBStringField
      FieldName = 'NR_PROCESSO'
      Origin = 'MAPA_LAB_PACIENTE.NR_PROCESSO'
      OnValidate = TB_MAPA_LAB_PACIENTENR_PROCESSOValidate
      Size = 15
    end
    object TB_MAPA_LAB_PACIENTETP_EXAME_CD4: TIBStringField
      FieldName = 'TP_EXAME_CD4'
      Origin = 'MAPA_LAB_PACIENTE.TP_EXAME_CD4'
      OnValidate = TB_MAPA_LAB_PACIENTETP_EXAME_CD4Validate
      FixedChar = True
      Size = 1
    end
    object TB_MAPA_LAB_PACIENTETP_EXAME_CV: TIBStringField
      FieldName = 'TP_EXAME_CV'
      Origin = 'MAPA_LAB_PACIENTE.TP_EXAME_CV'
      OnValidate = TB_MAPA_LAB_PACIENTETP_EXAME_CD4Validate
      FixedChar = True
      Size = 1
    end
    object TB_MAPA_LAB_PACIENTETP_EXAME_DPI: TIBStringField
      FieldName = 'TP_EXAME_DPI'
      Origin = 'MAPA_LAB_PACIENTE.TP_EXAME_DPI'
      OnValidate = TB_MAPA_LAB_PACIENTETP_EXAME_CD4Validate
      FixedChar = True
      Size = 1
    end
    object TB_MAPA_LAB_PACIENTETP_EXAME_TB: TIBStringField
      FieldName = 'TP_EXAME_TB'
      Origin = 'MAPA_LAB_PACIENTE.TP_EXAME_TB'
      OnValidate = TB_MAPA_LAB_PACIENTETP_EXAME_CD4Validate
      FixedChar = True
      Size = 1
    end
    object TB_MAPA_LAB_PACIENTETIPO_EXAME: TStringField
      FieldKind = fkCalculated
      FieldName = 'TIPO_EXAME'
      Size = 5
      Calculated = True
    end
    object TB_MAPA_LAB_PACIENTECD_AGENDA: TIntegerField
      FieldName = 'CD_AGENDA'
      Origin = 'MAPA_LAB_PACIENTE.CD_AGENDA'
    end
    object TB_MAPA_LAB_PACIENTENR_LAB: TIntegerField
      FieldName = 'NR_LAB'
      Origin = 'MAPA_LAB_PACIENTE.NR_LAB'
    end
    object TB_MAPA_LAB_PACIENTEDT_RESULTADO: TDateTimeField
      FieldName = 'DT_RESULTADO'
  ...
  object qyExport: TIBQuery
    ...
    SQL.Strings = (
      'select  '
      '       '#39'TODOS'#39' TODOS'
      '      ,"MAPA_LAB_PACIENTE"."CD_MAPA_PACIENTE"'
      '      ,"MAPA_LAB_PACIENTE"."CD_MAPA"'
      '      ,"MAPA_LAB_PACIENTE"."CD_PACIENTE"'
      '      ,"MAPA_LAB_PACIENTE"."NM_PACIENTE"'
      '      ,"MAPA_LAB_PACIENTE"."FL_SEXO"'
      ...
      ' ON  CD_INVESTIGADOR = "MAPA_LAB_PACIENTE"."CD_TECNICO"'
      ' INNER JOIN "MAPA_LAB"'
      ' ON "MAPA_LAB_PACIENTE"."CD_MAPA" = "MAPA_LAB"."CD_MAPA"'
      'ORDER BY "MAPA_LAB"."DT_MAPA" desc')
    Left = 362
    Top = 326
  end
