...
type
  TfrmCadCriancaExposta = class(TfrmCadPadSG)
    Panel5: TPanel;
    Label21: TLabel;
    Label20: TLabel;
    Label1: TLabel;
...
var
  frmCadCriancaExposta: TfrmCadCriancaExposta;
...
procedure TfrmCadCriancaExposta.GeraXML;
...
procedure TfrmCadCriancaExposta.CarregaComboAno;
...
procedure TfrmCadCriancaExposta.CriaGrid;
...
begin
  ...
  sgCriancaExposta.Cells[2,0]  := 'N. de Diagnóstico Definitivo de Crianças Expostas';
  sgCriancaExposta.Cells[0,0]  := 'Ano';
  sgCriancaExposta.Cells[1,0]  := 'Nr. de Gravidez que fizeram PTV';
  sgCriancaExposta.Cells[2,1]  := 'Crianças expostas result +';
  sgCriancaExposta.Cells[3,1]  := 'Crianças expostas result -';
  sgCriancaExposta.Cells[4,1]  := 'Ccas Exposta sem informação';
...
procedure TfrmCadCriancaExposta.Varregrid;
var i:integer;
...
procedure TfrmCadCriancaExposta.AbreConsultas;
begin
...
procedure TfrmCadCriancaExposta.FechaConsultas;
begin
  qyProvincia.Close;
  qyMunicipio.Close;
  qyUnidade.Close;
...
procedure TfrmCadCriancaExposta.CalculaTotal;
...
procedure TfrmCadCriancaExposta.CarregaGrid(TB_CRIANCAS_EXP:TDataSet);
...
procedure TfrmCadCriancaExposta.FormShow(Sender: TObject);
begin
  inherited;
  qyGrid.Open;
  CriaGrid;
...
procedure TfrmCadCriancaExposta.FormClose(Sender: TObject;
...
procedure TfrmCadCriancaExposta.sgCriancaExpostaDrawCell(Sender: TObject; ACol,
...
procedure TfrmCadCriancaExposta.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TfrmCadCriancaExposta.btIncluirClick(Sender: TObject);
begin
  pgGeral.ActivePageIndex := 1;
...
procedure TfrmCadCriancaExposta.sgCriancaExpostaSelectCell(Sender: TObject;
...
procedure TfrmCadCriancaExposta.btgravarClick(Sender: TObject);
begin
...
procedure TfrmCadCriancaExposta.sgCriancaExpostaSetEditText(
...
procedure TfrmCadCriancaExposta.pgGeralChange(Sender: TObject);
//var  i:integer;
begin
  inherited;
{
...
procedure TfrmCadCriancaExposta.btConsultarClick(Sender: TObject);
...
procedure TfrmCadCriancaExposta.grDadosDblClick(Sender: TObject);
begin
  inherited;
  Limpar;
  if pgGeral.ActivePageIndex=1 then
...
procedure TfrmCadCriancaExposta.ckConsolidarClick(Sender: TObject);
begin
  inherited;
...
procedure TfrmCadCriancaExposta.cbAnoChange(Sender: TObject);
begin
  inherited;
  sgCriancaExposta.Repaint;
...
procedure TfrmCadCriancaExposta.btexcluirClick(Sender: TObject);
...
procedure TfrmCadCriancaExposta.btLimparClick(Sender: TObject);
begin
  inherited;
  Limpar;
end;

procedure TfrmCadCriancaExposta.btCancelarClick(Sender: TObject);
begin
  if bConsolidado then
  begin
    MessageDlg('Dados em modo de consolidação, não podem ser modificados!',mtInformation,[mbOK],0);
...
procedure TfrmCadCriancaExposta.bteditarClick(Sender: TObject);
begin
  pgGeral.ActivePageIndex := 1;
...
procedure TfrmCadCriancaExposta.btimprimirClick(Sender: TObject);
begin
...
function TfrmCadCriancaExposta.ValidaExclusao: boolean;
begin
  try
...
procedure TfrmCadCriancaExposta.Limpar;
begin
  inherited;
  leProvincia.Text:='';
  leMunicipio.Text:='';
...
procedure TfrmCadCriancaExposta.leProvinciaChange(Sender: TObject);
begin
  inherited;
...
procedure TfrmCadCriancaExposta.leMunicipioChange(Sender: TObject);
begin
  inherited;
...
procedure TfrmCadCriancaExposta.leUnidadeChange(Sender: TObject);
begin
  inherited;
