...
uses
  ...
  IBCustomDataSet, IBQuery, pngimage, ExtCtrls, StdCtrls, Buttons, ComCtrls,
...
type
  TfrmProtocoloEnvio = class(TForm)
    ...
    TB_PROTOCOLO_ENVIOUND_ENVIO: TIBStringField;
...
procedure TfrmProtocoloEnvio.BitBtn3Click(Sender: TObject);
begin
  Visualizar1Click(Sender);
end;

procedure TfrmProtocoloEnvio.BitBtn1Click(Sender: TObject);
begin
  TB_PROTOCOLO_ENVIO.Close;
  TB_PROTOCOLO_ENVIO.Open;
end;
